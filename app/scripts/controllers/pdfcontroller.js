...
/*global app:true*/
/*global $:false */
app.controller("AnnotationController",['$scope','$timeout', function($scope, $timeout) {
...
}]).controller("PdfController", ['$scope','$timeout','NGAnnotation', function($scope, $timeout, NGAnnotation) {
